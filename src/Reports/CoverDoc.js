...
import CoverHeader from "./CoverDoc/CoverHeader"
import AmharicFont from "./font/ebrima.ttf";

import CoverStyles from "./CoverDoc/CoverStyles";

import BtDynamic from "./Table/BtDynamic";
  ...
  return (
    <PDFViewer style={{ width: "100%", height: 700 }}>
      <Document title="Loan Cover">
        <Page style={CoverStyles.body} wrap>
          <CoverHeader />
          {Object.keys(loan).length > 0 ? (
            <>
              <Text style={CoverStyles.space}></Text>
              <View style={CoverStyles.fullbox}>
                <Text style={CoverStyles.text}>
